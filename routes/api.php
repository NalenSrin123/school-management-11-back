...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/course-detail/{id}', [CourseController::class, 'getCourseDetail']);
    Route::get('/video-guide-lines', [VideoGuideLineController::class, 'index']);
    Route::post('/video-guide-lines', [VideoGuideLineController::class, 'store']);
    Route::get('/video-guide-lines/{id}', [VideoGuideLineController::class, 'show']);
    Route::patch('/video-guide-lines/{id}', [VideoGuideLineController::class, 'update']);
    Route::delete('/video-guide-lines/{id}', [VideoGuideLineController::class, 'destroy']);
